...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">Eko-Market</a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                @else
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{ url('buyerdash') }}">Home</a>
                                </li>

                                    <li class="nav-item">
                                    <a class="nav-link" href="{{ route('allproducts') }}">Products 
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('cartlist') }}">Cart <i
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="{{ url('getlogistics') }}">Logistics/Market Survey
                                        {{-- <span class="badge badge-pill bg-success wish-count">0</span> --}}
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('getdelivery') }}">Delivery Request
                                        {{-- <span class="badge badge-pill bg-success wish-count">0</span> --}}
                                    </a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="{{ route('mydeliveryreq') }}">
                                                My Delivery Request
                                            </a>

                                              <a class="dropdown-item" href="{{ route('deliveryrequestemail') }}">
                                                Received Emails
                                            </a>
                                            

                                            <a class="dropdown-item" href="{{ route('mysurvey') }}">
                                                My Survey Request
                                            </a>
